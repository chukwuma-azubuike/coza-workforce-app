...
import { CREATE_SERVICE_ENUM, IAssignGroupHead, ICreateServicePayload } from '../../../store/types';
import Utils from '../../../utils';
import { AssignGroupHeadSchema, CreateServiceSchema } from '../../../utils/schemas';
...
} from '../../../store/services/department';
...
const CreateGroupHead: React.FC<NativeStackScreenProps<ParamListBase>> = ({ navigation }) => {
    ...
    const { data: users } = useGetUsersQuery({ departmentId: department?.id }, { refetchOnMountOrArgChange: true });
    ...
    const onSubmit: FormikConfig<IAssignGroupHead>['onSubmit'] = async (values, { resetForm }) => {
        ...
        const payload = { departments, userId: values.worker };
                                    ...
                                    <VStack space={2}>
                                        ...
                                        <FormControl>
                                            ...
                                            <SelectComponent
                                                ...
                                                onValueChange={(value: any) => handleInputChange('department', value)}
                                                id="department"
...
export default CreateGroupHead;
