import { Center, HStack, Heading, Stack, Text, VStack } from 'native-base';
            ...
            <ViewWrapper scroll>
                <HStack>
                    {campusInfo.map((item, index) => (
                        ...
                        //     </Text>
                        // </Stack>
                        <StatCardComponent key={index} label={item.name} value={item.value} />
                    ))}
                </HStack>
                ...
                <Center>
                    <Stack py={3} flexDirection="row" flexWrap="wrap">
                        {Departmentlist?.map((item, index) => (
                            <StatCardComponent key={index} label={item.title} value={item.value} />
                            // <Stack
                            //     key={index}
                            //     px="2"
