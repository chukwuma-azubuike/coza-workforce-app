...
export const NavigationContext = React.createContext({
    navigationState: null as any as NativeStackNavigationProp<
        ParamListBase,
        string,
        undefined
    >,
...
const TabBar: React.FC<any> = ({ state, descriptors, navigation }) => {
    // const [navigationState, setNavigationState] = React.useState(navigation);

    return (
        <NavigationContext.Provider value={{ navigationState: navigation }}>
            <HStack
                px={2}
                bg="gray.100"
                borderTopWidth={0.5}
